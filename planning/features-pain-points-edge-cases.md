...
- File có mật khẩu.
- PDF scan bị mờ hoặc OCR đọc sai.
- File quá lớn.
- Người dùng upload trùng file.
- Tài liệu bị xóa nhưng dữ liệu vẫn còn trong hệ thống.
- Người dùng không có quyền nhưng vẫn cố tìm kiếm tài liệu.
- Câu hỏi quá ngắn hoặc quá mơ hồ.
- Không có tài liệu nào liên quan đến câu hỏi.
- Nhiều tài liệu trả về thông tin khác nhau.
